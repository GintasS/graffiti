...
def update_user_password_after_recovery_email():
    try:
        ...
        # TODO: Are we exposing sensitive exception data to the user?
...
def update_user_password_user_is_authenticated():
    try:
        ...
        password_change_history = create_user_password_reset_history_entity(found_user.id, UserPasswordResetType.AUTHENTICATED)
